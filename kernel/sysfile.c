...
{
    printf("sys_disk_fail_raid pokrenut\n");
    return 0;
}
...
{
    printf("sys_disk_repaired_raid pokrenut\n");
    return 0;
}
...
{
    printf("sys_destroy_raid pokrenut\n");
    return 0;
}